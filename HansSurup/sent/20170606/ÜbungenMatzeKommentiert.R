...
# ausschließen.
unique(tableMatze$TEILNEHMER_SIC) # Aber wie erstelle ich daraus eine Baseline- Untergruppe mit dem jeweils
                                  # ersten SIC Wert?
...
# Jetzt kann man schon einfach eine Korrelation erstellen. Einem neuen Wert (cor)wird die Funktion
...
# Der p-Wert ist schonmal niedrig, aber der Korrelationskoeffizient ist lediglich -0,03. Habe eben jetzt mal schnell irgendwelche Daten genommen,
...
# Paket bei mir nicht installieren.
...
help("sort")
subset(tableMatze, tableMatze$TEILNEHMER_GESCHLECHT=="1")
